        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Senarai Kontak</h4>
                    ...
                    <div class="col-7">
                        <div class="text-right upgrade-btn">
                            <a href="add-contact.php" class="btn btn-primary text-white"
                               style="background-color: #4fc3f7; border: none;"><i class="fa fa-plus-square"></i>Tambah Kontak</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    while ($row = $result-> fetch_assoc()) {?>
                                        <tr>
                                            ...
                                            <a href="../../php/deletecontact.php?ID=<?php echo  $row["id"] ?>"><i onclick="return confirm('Hapus Kontak ini?')" aria-hidden="true" class="fas fa-trash-alt"></i></a>&nbsp&nbsp&nbsp 
