                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="manage-access.php" aria-expanded="false"><i
                                    class="mdi mdi-account-network"></i><span class="hide-menu">Megurus Akses</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Tambah Kontak Baru</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="../../php/addcontact.php" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-md-12">Jenis Nombor[Whatsapp|Telefon|Faks]</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Masukkan Jenis Nombor" name="name"
                                                class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Nombor Telefon</label>
                                        <div class="col-md-12">
