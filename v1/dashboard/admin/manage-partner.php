                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="../../../php/updateprofile.php">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Masukkan nama penuh" name="partnerName" value="<?php echo $admin['adName'];?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Keterangan Syarikat Rakan Kongsi</label>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="contoh@pusakapelangi.com" name="partnerDesc" value="<?php echo $admin['email'];?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password"
                                                class="form-control form-control-line"  name="partnerImej" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
