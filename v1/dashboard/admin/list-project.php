                                ...
                                <table class="table table-hover">
                                    ...
                                    while ($row = $result-> fetch_assoc()) {?>
                                        <tr>
                                            ...
                                            <td><img style="max-height: 20%; max-width: 20%;" src="../../uploads/<?php echo $row["imej"]?>"></td>
                                            <td><?php echo $row["projekName"] ?></td>
                                            <td style="text-align: center;">
                                            <a href="../../php/deletepartner.php?ID=<?php echo  $row["id"] ?>"><i onclick="return confirm('Hapus gambar projek ini?')" aria-hidden="true" class="fas fa-trash-alt"></i></a>&nbsp&nbsp&nbsp                               
                                        </tr>
                                    <?php $i++;
                                        }                                    
                                    } ?>
