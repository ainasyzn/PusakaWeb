                                ...
                                <table class="table table-hover">
                                    ...
                                    while ($row = $result-> fetch_assoc()) {?>
                                        <tr>
                                            ...
                                            <a href="../../php/deleteprojek.php?ID=<?php echo  $row["id"] ?>"><i onclick="return confirm('Hapus gambar projek ini?')" aria-hidden="true" class="fas fa-trash-alt"></i></a>&nbsp&nbsp&nbsp                               
                                        </tr>
                                    <?php $i++;
                                        }                                    
                                    } ?>
